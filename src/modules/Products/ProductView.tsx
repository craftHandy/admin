...
//       const response = await api.put(`/api/v1/admin/product/${id}`, payload);
//       return response.data;
//     },
//     onSuccess: () => {
            ...
            <div className="space-y-4 rounded-xl border border-border bg-card p-6 shadow-xs">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <FormTextarea
                  ...
                  name="description"
                  label="Description *"
                  placeholder="Write descriptive details about the product..."
...
function ProductImagePreview({
  ...
  if (
    ...
    return (
      <div className="flex min-h-40 flex-col items-center justify-center rounded-lg border border-dashed border-border text-sm text-muted-foreground">
