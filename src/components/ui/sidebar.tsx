    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col border-r border-border/60 bg-sidebar/95 group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border group-data-[variant=floating]:border-border/60 group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
